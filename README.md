...
<img src="imgs/turtlebot3.png" width="600"/></div>
...
- [Micro SD Card Reader](https://goo.gl/AGr2h5)
...
4. [Navigation Stack Setup](#navigation-stack-setup)

5. [Simulation Setup](#simulation-setup)

   <div style="width:image width px; font-size:80%; text-align:center;">
   <img src="imgs/functions.jpg" width="600"/></div>

### 1. Remote PC Setup

##### 1.1 [Install](http://wiki.ros.org/kinetic/Installation/Ubuntu) ROS Kinetic on Remote PC
...
The Turtlebot3 WafflePi SD card has already been preconfigured. If you wish to reinstall the image or prepare an image for a new turtlebot please see [2.4](#2.4-[optional]-**setup-new-rpi3-image-for-turtlebot3*)
...
<div style="width:image width px; font-size:80%; text-align:center;">
<img src="imgs/network_configuration.png" width="600"/></div>
...
<div style="width:image width px; font-size:80%; text-align:center;">
<img src="imgs/ifconfig_pc.png" width="600"/></div>
...
<div style="width:image width px; font-size:80%; text-align:center;">
<img src="imgs/bashrc_pc.png" width="600"/></div>
...
<div style="width:image width px; font-size:80%; text-align:center;">
<img src="imgs/bashrc_rpi3.png" width="600"/></div>
